	...
	<section class="psweb-register">
	  <div class="container">
	    <div class="plans-title">
	      <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.9s">Su registro no ha sido completado</h4>
	      <h2 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.1s">Algo ha fallado!</h2>
	    </div>
	    <p>Por favor intente realizar el pago nuevamente. Si el error persiste, contactenos!</p>
	  </div>
	</section>
