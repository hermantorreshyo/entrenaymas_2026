...
<div class="buscador_neumaticos_sidebar">
  <div class="filters" id="buscador_neumaticos_sidebar_por_medida">
    <div class="title">Filtrar por medida</div>
    <form method="get" action="<?php echo mklink("productos/"); ?>" class="tab-content" id="for-rent">
      <div class="buscador_neumaticos_select_cont">
      ...
      <div class="">
        <input type="submit" value="buscar" class="btn bg-sec" />
      </div>
    </form>
  </div>
  <?php if ($empresa->id != 433) { ?>
    <div class="filters" id="buscador_neumaticos_sidebar_por_vehiculo">
      <div class="title">Filtrar por Veh&iacute;culo</div>
