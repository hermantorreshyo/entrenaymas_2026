...
$incluir_turnos = (isset($empresa->tipo_empresa)) ? (($empresa->tipo_empresa == 2)?1:0) : 0;
?>
...
<?php include_once("ldjson/organization.php"); ?>
...
<?php if (isset($incluir_buscador_neumaticos) && $incluir_buscador_neumaticos == 1) { ?>
  <?php include_once("neumaticos/buscador_css.php"); ?>
<?php } ?>
