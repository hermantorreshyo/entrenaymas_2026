...
$vc_codigo_postal = ( (isset($carrito->codigo_postal) && !empty($carrito->codigo_postal)) ? $carrito->codigo_postal : ( (isset($_COOKIE["codigo_postal"]) && !empty($_COOKIE["codigo_postal"])) ? $_COOKIE["codigo_postal"] : "" ) );
$vc_telefono = ( (isset($carrito->telefono) && !empty($carrito->telefono)) ? $carrito->telefono : ( (isset($_COOKIE["telefono"]) && !empty($_COOKIE["telefono"])) ? $_COOKIE["telefono"] : "" ) );
$vc_email = ( (isset($carrito->email) && !empty($carrito->email)) ? $carrito->email : ( (isset($_COOKIE["email"]) && !empty($_COOKIE["email"])) ? $_COOKIE["email"] : "" ) );
...
$ll = array(
  ...
  "titulo_registro"=>"Regístrate para comprar",
  "registro_nombre_label"=>"Nombre y Apellido",
  "registro_celular_label"=>"Teléfono",
  "registro_dni_label"=>"Identificación",
  "registro_direccion_facturacion_label"=>(($empresa->id == 758)?"Direcci&oacute;n":"Direcci&oacute;n para facturaci&oacute;n"),
  "registro_email_label"=>"E-mail",
  "registro_continuar"=>"Continuar",
  "registro_celular_placeholder"=>"",
  "titulo_recibir_producto"=>"¿Cómo quieres recibir tu producto?",
  ...
  "continuar"=>"Continuar",
  "titulo_donde_recibirlo"=>"¿Dónde quieres recibirlo?",
  "direccion"=>"Dirección",
  "ciudad"=>"Ciudad",
  ...
  "titulo_pagar"=>"¿Cómo quieres pagar?",
...
if ($checkout_language == "en") {
  ...
  $ll["gratis"] = "Free";
  $ll["total"] = "Total";
  $ll["registro_celular_placeholder"] = "";
}
              ...
              <div class="varcreative-panel-body">
                ...
                <div class="row">
                  ...
                  <?php if (isset($empresa->tienda_registro_telefono) && $empresa->tienda_registro_telefono == 1) { ?>
                    <div class="varcreative-col6">
                      <div class="varcreative-form-group">
                        <input type="number" class="varcreative-input" onfocus="add_placeholder(this)" onblur="remove_placeholder(this)" data-placeholder="<?php echo $ll["registro_celular_placeholder"] ?>" required id="registro_telefono" value="<?php echo $vc_telefono ?>" name="telefono" />
                  ...
                  <div class="varcreative-col6">
                    <div class="varcreative-form-group">
                      <input type="text" id="registro_codigo_postal" class="varcreative-input" value="<?php echo $vc_codigo_postal ?>" name="codigo_postal" />
                      <span class="varcreative-label">Código Postal</span>
                    </div>
                  </div>
                ...
                <div class="varcreative-form-group">
                  <input type="text" id="registro_email" required class="varcreative-input" value="<?php echo $vc_email ?>" name="email" />
                  <span class="varcreative-label"><?php echo $ll["registro_email_label"] ?></span>
                </div>

                <?php if (isset($empresa->tienda_registro_password) && $empresa->tienda_registro_password == 1) { ?>
                  <div class="varcreative-form-group">
        ...
        // PASO 4: FORMAS DE PAGO
          ...
          <div class="varcreative-panel panel_activo">
            ...
            <a href="javascript:void(0)" class="varcreative-panel-heading"><?php echo $ll["titulo_pagar"] ?></a>  
              ...
              <?php 
              // PAGO CON PAYPAL
              if ($carrito_model->get_paypal() !== FALSE) { ?>
                <div class="varcreative-option-btn varcreative-option-pago-paypal" onclick="varcreative_forma_pago('paypal')">
                  Paypal
                </div>
              <?php } ?>
              ...
              <?php
              // PAGO CON STRIPE
              if ($carrito_model->get_stripe() !== FALSE) { ?>
                <div class="varcreative-option-btn varcreative-option-pago-stripe" onclick="varcreative_forma_pago('stripe')">
                  Stripe
                </div>
              <?php } ?>
          ...
          // ULTIMO PASO: MOSTRAMOS EL RESUMEN DE TODO LO ELEGIDO
            ...
            <div class="varcreative-panel panel_activo">
              <a href="javascript:void(0)" class="varcreative-panel-heading">Resumen de Compra</a>
              <div class="varcreative-option-btn">
                <div>
                  <b><?php echo $carrito->cliente ?></b>
                  <a class="varcreative-option-edit" href="javascript:void(0)" onclick="varcreative_volver_atras(0)"><?php echo $ll["modificar"] ?></a>
                </div>
                <div style="margin-top: 5px;">
                  <?php echo $carrito->email ?>
                </div>
              </div>
            </div>
            ...
            <div class="varcreative-panel panel_activo">
              <a href="javascript:void(0)" class="varcreative-panel-heading">Pago con Stripe</a>  
            </div>

            <?php 
            // SI ESTAMOS EN EL ULTIMO PASO
            // TIENE QUE ESTAR REGISTRADO EN LA BASE DE DATOS
            $items = array();
            if ($carrito->numero_paso == 99 && $carrito->id > 0) { 
              $peso_total = 0;
              ...
              <div class="varcreative-panel panel_activo" style="margin-bottom: 40px; overflow: hidden;">
                <div id="finalizar_pago_container" class="tac mt10">
                  ...
                  <?php if ($carrito->total >= $empresa->tienda_compra_minima) { ?>
                    ...
                    <?php if (strtolower($carrito->forma_pago) == "mercadopago") { 
                      ...
                      <div id="finalizar_mp">
                        ...
                        if ($metodo_envio->forma_envio == "MERCADOENVIOS" 
                          ...
                          && (isset($carrito->excepcion_envio)) && $carrito->excepcion_envio == 0) {
                          $items[] = array(
                            "id"=>0,
                            "title"=>$ll["costo_envio"],
                            "currency_id"=>$moneda_mp,
                        ...
                        if ($metodo_envio->forma_envio == "MERCADOENVIOS" 
                          ...
                          if ($carrito->ancho_total > 0 && $carrito->alto_total > 0 && $carrito->profundidad_total > 0 && $peso_total > 0) {
                            ...
                            $preference_data["shipments"] = array(
                              "mode"=>"me2",
                              "dimensions"=>$dimensiones.",".round($peso_total * 1000,0),
                            );
                            if (!empty($carrito->codigo_postal)) {
                              $preference_data["shipments"]["receiver_address"] = array(
                                "zip_code" => $carrito->codigo_postal,
                                "street_name" => $carrito->direccion,
                              );
                            }
                            // Si el envio es gratuito
                            if ($carrito->costo_envio <= 0 && $carrito->forma_envio == "envio_domicilio") {
                              $preference_data["shipments"]["free_methods"] = array(
                                array("id" => 73328), // Oca Estandar
                                array("id" => 501045),
                                array("id" => 502845),
                                array("id" => 501145),
                                array("id" => 505045),
                        ...
                        /*
                        } else if ($carrito->retiro_sucursal == 1) {
                          $preference_data["shipments"] = array(
                            "mode"=>"me2",
                            "local_pickup"=>true,
                          );*/
                        ...
                        try {
                          file_put_contents("/home/ubuntu/data/log_preference_data.txt", print_r($preference_data,TRUE), FILE_APPEND);
                          $preference = $mp->create_preference($preference_data); ?>
                          <a id="finalizar_mp" href="<?php echo $preference["response"]["init_point"]; ?>" mp-mode="modal" name="MP-Checkout" class="varcreative-btn finalizar"><?php echo $boton_confirmar_compra ?></a>
                    ...
                    <?php } else if ($carrito->forma_pago == "paypal") { ?>
                      <?php /*
                      <div id="finalizar_pago_paypal">
                        <form onsubmit="return finalizar_pago_paypal()" id="finalizar_paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                          <input type="hidden" name="business" value="<?php echo $carrito_model->get_paypal() ?>">
                          <INPUT TYPE="hidden" name="cmd" value="_xclick">
                          <INPUT TYPE="hidden" name="charset" value="utf-8">
                          <INPUT TYPE="hidden" NAME="return" id="paypal_return">
                          <INPUT TYPE="hidden" name="custom" id="paypal_custom">
                          <input type="hidden" name="quantity" value="1">
                          <input type="hidden" name="item_name" value="Reserva en: <?php echo $propiedad->nombre ?>">
                          <input type="hidden" name="item_number" value="1">
                          <input type="hidden" name="amount" value="<?php echo (($propiedad->moneda == 'ARS' && $propiedad->cotizacion != 0) ? ($propiedad->total_con_impuestos / $propiedad->cotizacion) : $propiedad->total_con_impuestos) ?>">
                          <input type="hidden" name="first_name" value="<?php echo $carrito->cliente ?>">
                          <input type="hidden" name="email" value="<?php echo $carrito->email ?>">
                          <INPUT TYPE="hidden" id="paypal_notification" NAME="notify_url">
                          <INPUT TYPE="hidden" NAME="shopping_url" value="<?php echo mklink("/"); ?>">
                          <INPUT TYPE="hidden" NAME="cancel_return" value="<?php echo mklink("compra-fail/"); ?>">
                          <INPUT TYPE="hidden" NAME="no_shipping" value="1">
                          <input id="finalizar_paypal_btn" type="submit" name="submit" class="varcreative-btn finalizar" value="<?php echo $boton_confirmar_compra ?>" />
                        </form>
                      </div>
                      */ ?>
                    <?php 
                    // INTEGRACION CON STRIPE
                    } else if ($carrito->forma_pago == "stripe") { 
                      $stripe_conf = $carrito_model->get_stripe(); ?>
                      <div id="finalizar_pago_stripe">
                      ...
                      <?php include("templates/comun/stripe_js.php"); ?>
                    <?php } ?>
        ...
        <div class="varcreative-col-resumen <?php echo ($carrito->numero_paso == 99)?"varcreative-col-resumen-active":"" ?>">
          <div class="varcreative-col-padding">
                ...
                <div class="producto producto_<?php echo $producto->id ?>">
                  ...
                  <div class="varcreative-avatar">
                    ...
                    <div class="varcreative-eliminar-item">
                      <img src="/templates/comun/img/pencil.png" alt="Editar" onclick="varcreative_ir_modificar_carrito()"/>
                    </div>
                  </div>
                  <div class="varcreative-item-info">
                    ...
                    <div class="varcreative-item-controls">
                      <div class="item-unit">
                        ...
                        <select class="varcreative-input varcreative-input-cantidad" data-id="<?php echo $producto->id ?>" onchange="cambiar_cantidad(this)">
            ...
            <div class="total_general varcreative-table-row">
              ...
              <span class="numero_total_general"><?php echo ($carrito->total == 0 && isset($carrito->codigo_promocional) && !empty($carrito->codigo_promocional)) ? "$ 0,00" : (format($carrito->total + (($carrito->costo_envio > 0) ? $carrito->costo_envio : 0))) ?></span>
            </div>
