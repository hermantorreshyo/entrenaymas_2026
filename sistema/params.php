...
if (!defined("GOOGLE_SMTP_PASSWORD")) { DEFINE ("GOOGLE_SMTP_PASSWORD",(isset($_SERVER["GOOGLE_SMTP_PASSWORD"]) ? $_SERVER["GOOGLE_SMTP_PASSWORD"] : "btxjfsztvabhmdbo")); }
...
if (!defined("RECAPTCHA_SITE_KEY")) { DEFINE ("RECAPTCHA_SITE_KEY",(isset($_SERVER["RECAPTCHA_SITE_KEY"]) ? $_SERVER["RECAPTCHA_SITE_KEY"] : "6LdkJF0tAAAAAHrmi8jfwE7uA11V6w6bQpl0i26m")); }
if (!defined("RECAPTCHA_SECRET_KEY")) { DEFINE ("RECAPTCHA_SECRET_KEY",(isset($_SERVER["RECAPTCHA_SECRET_KEY"]) ? $_SERVER["RECAPTCHA_SECRET_KEY"] : "6LdkJF0tAAAAACKJuBGdPkeYszgdERlYwIMkan-n")); }
