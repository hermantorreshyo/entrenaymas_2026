...
<html lang="en">
<head>
<title>Registro Inmovar.com</title>
...
<div class="container">
    <div class="wrapper-md">
        <div class="seccion_vacia">
          <h1 class="h1">Bienvenido a su cuenta de Inmovar!</h1>
          <h3 class="h3">Complete los siguientes datos para empezar a trabajar</h3>
        </div>    
        <form method="post" action="/sistema/registro/guardar_inmovar/" onsubmit="return guardar()" class="tab-container">
            ...
            <div class="tab-content">
                <div id="tab1" class="tab-pane active">
                    ...
                    <div>
                      ...
                      <input type="text" id="registro_razon_social" name="razon_social" class="form-control" >
                      <p class="m-t">Direcci&oacute;n:</p>
                      <input type="text" id="registro_direccion" name="direccion" class="form-control" >
                ...
                <div id="tab2" class="tab-pane">
                    ...
                    <div>
                        ...
                        <div id="configuracion_color">
                            ...
                            <select name="color" id="registro_color" class="form-control">
                        ...
                        <p class="m-t">Elige el dise&ntilde;o que m&aacute;s te guste:</p>
                        <div class="oh">
                            <?php foreach($templates as $t) { ?>
                                <div class="template_cont col-xs-12 col-md-6 m-b-lg">
                                    <div>
                                        <img src="/templates/<?php echo $t->path ?>/thumb.jpg" class="b b-a wrapper-xs thumbnail_img bg-white img-responsive">
                                    </div>
                                    <div class="radio">
                                        <label class="i-checks">
                                          <input type="radio" name="id_web_template" value="<?php echo $t->id ?>">
                                          <i></i><?php echo $t->nombre ?>
                                        </label>
                                    </div>                                
                                </div>
                            <?php } ?>
...
$(document).ready(function(){
    ...
    $(".thumbnail_img").click(function(e){
        $(e.currentTarget).parent().next().find(".i-checks").trigger("click");
    });
    ...
    $("input[name='id_web_template']").change(function(e){
