<script type="text/template" id="mostradores_resultados_template">
<% if (!seleccionar) { %>
<div class="bg-light lter b-b wrapper-md ng-scope">
  <div class="row clearfix padder">
    <h1 class="m-n font-thin h3 pull-left"><i class="fa fa-desktop icono_principal mr10"></i>Mostrador</h1>
  </div>
</div>
          ...
          <div class="row">
            <div class="col-md-6 col-lg-3 sm-m-b">
              <div class="input-group">
                  <input type="text" id="mostradores_buscar" placeholder="Buscar..." autocomplete="off" class="form-control">
          ...
          <div class="wrapper clearfix">
            ...
            <div class="form-inline">    
              ...
              <div class="input-group" style="width: 140px;">
                <input type="text" placeholder="Desde" id="mostradores_desde" class="form-control">
                <span class="input-group-btn">
                  <button tabindex="-1" type="button" class="btn btn-default btn-cal"><i class="glyphicon glyphicon-calendar"></i></button>
                </span>              
              </div>
              <div class="input-group" style="width: 140px;">
                <input type="text" placeholder="Hasta" id="mostradores_hasta" class="form-control">
                <span class="input-group-btn">
                  <button tabindex="-1" type="button" class="btn btn-default btn-cal"><i class="glyphicon glyphicon-calendar"></i></button>
                </span>              
              </div>
        ...
        */ ?>
        ...
        <div class="panel-body">
            <div class="b-a table-responsive">
                <table id="mostradores_tabla" class="table table-striped sortable m-b-none default footable">
                    <thead>
                        <tr>
                            <% if (!seleccionar) { %>
                              <th style="width:20px;">
...
<script type="text/template" id="mostradores_item_resultados_template">
