<script type="text/template" id="marcas_panel_template">
  <div class="bg-light lter b-b wrapper-md ng-scope">
    <h1 class="m-n font-thin h3"><i class="fa fa-cogs icono_principal"></i>Configuración
      / <b>Colaboradores</b>
    </h1>
  </div>
...
<script type="text/template" id="marcas_edit_mini_panel_template">
<div class="panel pb0 mb0">
  <div class="panel-body">
    ...
    <div class="form-group">
      <input placeholder="Nombre" type="text" name="nombre" class="form-control tab" id="marcas_mini_nombre" value="<%= nombre %>"/>
    </div>
