<script type="text/template" id="clasificados_categorias_tree_panel_template">
    ...
    <div class="wrapper-md pb0">
        <div class="panel panel-default">
            <div class="panel-heading oh">
                <a class="btn btn-success btn-sm btn-addon" href="app/#clasificado_categoria">
                    <i class="fa fa-plus"></i>
                    <span class="hidden-xs">Nuevo</span>
                </a>
            </div>
            <div class="panel-body oh">
                <div id="clasificados_categorias_tree" style="height: 400px; overflow: auto;"></div>
            </div>
...
<script type="text/template" id="clasificados_categorias_panel_template">
    ...
    <div class="wrapper-md ng-scope pt0">
        <div class="panel panel-default">
            ...
            <div class="panel-heading oh">
                ...
                <a class="btn pull-right btn-success btn-addon" href="app/#clasificado_categoria"><i class="fa fa-plus"></i>Nuevo</a>
            </div>
            <div class="panel-body">
                <div class="b-a table-responsive">
                    <table id="clasificados_categorias_table" class="table sortable m-b-none default footable">
                        <thead>
                            <tr>
                                <th>Nombre</th>
                                <% if (permiso > 1) { %>
...
<script type="text/template" id="clasificados_categorias_item">
...
<script type="text/template" id="clasificados_categorias_edit_panel_template">
          ...
          <div id="tab1" class="tab-pane active panel-body">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <% if (edicion) { %>
                            <input type="text" name="nombre" class="form-control" id="clasificados_categorias_nombre" value="<%= nombre %>"/>
                        <% } else { %>
                            <span><%= nombre %></span>
                        <% } %>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <select class="form-control" name="id_padre" id="clasificados_categorias_padre">
						  <option value="569" <%= (id_padre==569)?"selected":"" %>>Comercios</option>
						  <option value="568" <%= (id_padre==568)?"selected":"" %>>Profesionales</option>
						</select>
                    </div>
                </div>
				  ...
				  <!--
				  <div class="form-group">
					  <label class="col-md-2 control-label">Atributos</label>
					  <div class="col-md-10">
						<input class="select2_textarea w100p" type="text" id="clasificados_categorias_atributos"/>
					  </div>
				  </div>
				  -->
