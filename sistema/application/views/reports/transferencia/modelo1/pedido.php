...
<?php echo $header; ?>
  <div class="p30">
    ...
    <div class="oh mb15">
      <div class="mb5">
        Origen: <b><?php echo $pedido->origen ?></b>
      </div>
      <div class="mb5">
        Destino: <b><?php echo $pedido->destino; ?></b><br/>
      </div>
    </div>
    <table class="tabla">
      <thead>
      ...
      <tbody>
        <?php foreach($pedido->items as $i) { 
          ...
          <tr>
            ...
            <td><?php echo (!empty($i->nombre))? mb_convert_encoding($i->nombre, 'ISO-8859-1', 'UTF-8'):""; ?></td>
