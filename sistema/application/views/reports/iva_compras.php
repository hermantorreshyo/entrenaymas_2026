...
foreach ($datos as $r) {
    ...
    if ($i == 0) {
        ...
        if (!empty($empresa->cuit)) $s.="CUIT: $empresa->cuit<br/>";
        if (!empty($empresa->direccion)) $s.="Domicilio: $empresa->direccion<br/>";
        echo $s;
...
if (!$cerro) {
    ...
    echo "<td class='tar'>".f($total_exento + $total_perc_ib + $total_perc_agip + $total_perc_iva + $total_imp_interno + $total_neto + $total_iva)."</td>";
    echo "</tr></tfoot>";
    echo "</table></div>";
}
...
<div class="">
    ...
    <tr style="border-top: solid 1px black">
        <td style="width: 25%">Subtotales</td>
        <td style="width: 12.5%"></td>
        <td style="width: 12.5%" class="tar"><b><?php $total_regimenes_especiales = $total_perc_ib + $total_perc_iva + $total_perc_agip; echo f($total_regimenes_especiales);?></b></td>
        <td style="width: 12.5%"></td>
        <td style="width: 12.5%" class="tar"></td>
        <td style="width: 12.5%" class="tar"></td>
