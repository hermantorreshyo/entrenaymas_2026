...
<div class="p30" style="position: relative">
    ...
    <div class="cb lh">
        ...
        <b>Apellido y Nombre o Denominaci&oacute;n: </b>REYNALDO, ERNESTO PEDRO <br/>
        <b>C.U.I.T.: </b>
        <?php if($empresa == 1) { ?>
            ERNESTO P. REYNALDO
        <?php } else if($empresa == 2) { ?>
            REYNALDO, ANA GRACIA
        <?php } ?>          
        <br/>
        <b>Domicilio: </b>
            <?php if($empresa == 1) { ?>
                Calle Avda. Vieytes Nº 52 - Localidad: Chacabuco Pcia. de Bs. As. C.P.: 6740
            <?php } else if($empresa == 2) { ?>
                Calle Avda. Vieytes Nº 52 - Localidad: Chacabuco Pcia. de Bs. As. C.P.: 6740
            <?php } ?>
    </div>
