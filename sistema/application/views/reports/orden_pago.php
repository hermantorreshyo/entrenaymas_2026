...
<body>
<div class="a4">
  <div class="a4_2 fl" style="padding-right: 20px; border-right: solid 1px black;">
    
    <div class="titulo">ORDEN DE PAGO</div>

    <div class="mt10 oh bold fs16 mb10">
      <?php echo strtoupper($empresa->razon_social); ?>
    </div>
    <?php if (!empty($empresa->direccion) && !empty($empresa->cuit)) { ?>
      <div class="mt10 oh">
    ...
    <?php } ?>
    <?php if (isset($orden_pago->sucursal) && !empty($orden_pago->sucursal)) { ?>
      <div>
        SUCURSAL: <?php echo $orden_pago->sucursal ?>
      </div>
    <?php } ?>
    ...
    <table class="tabla mt10" cellpadding=0 cellspacing=0>
      ...
      <?php foreach($orden_pago->comprobantes as $comprobante) { ?>
        <?php
        if ($comprobante->id_tipo_comprobante == 3 || $comprobante->id_tipo_comprobante == 8 || $comprobante->id_tipo_comprobante == 13 || $comprobante->id_tipo_comprobante == 21) {
        ...
        <tr>
          ...
          <td class="tar"><?php echo $comprobante->simbolo." ".$comprobante->numero; ?></td>
          <?php if ($comprobante->id_tipo_comprobante == 3 || $comprobante->id_tipo_comprobante == 8 || $comprobante->id_tipo_comprobante == 13 || $comprobante->id_tipo_comprobante == 21) { ?>
  ...
  <div class="a4_2 fl" style="padding-left: 20px">
    <div class="titulo">ORDEN DE PAGO</div>
