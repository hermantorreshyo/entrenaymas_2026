...
$piezas_items = array_chunk($factura->items, 10);
?>
<div id="printable">
		...
		<div class="a4">
			<div class="inner">
				<div id="invoice" class="new"><!-- INVOICE -->
					...
					<section id="info-to">
						<div class="invoice-to">
							<div class="invoice-to-title">
								<?php echo (isset($factura->cliente->nombre) ? $factura->cliente->nombre : ""); ?>
							</div>
							<div class="to-org">
								<?php
	              ...
	              if (isset($factura->codigo_postal) && !empty($factura->codigo_postal)) {
	                echo "Cod. Postal: ".$factura->codigo_postal."<br/>";
	              }
										...
										<tr>
											<td>
												<h1>
													...
													<?php echo (!empty($i->descripcion)?"<br/><span class='fwn'>". ($i->descripcion)."</span>":""); ?>
													<?php if ($factura->id_empresa == 120) { 
														echo "<br/><span class='fwn'>". round($i->alto,0)." / ".round($i->ancho,0)." / ".round($i->profundidad,0)."</span>";
													} ?>
												</h1>
											</td>
