...
<div class="container">
    <div class="wrapper-md">
        ...
        <form method="post" action="registro/guardar/" onsubmit="return guardar()" class="tab-container">
            ...
            <div class="tab-content">
                <div id="tab1" class="tab-pane active">
                    ...
                    <div>
                      ...
                      <p class="m-t">Contrase&ntilde;a:</p>
                      <input type="password" id="registro_password" class="form-control" >
                      <p class="m-t">Repetir contrase&ntilde;a:</p>
                      <input type="password" id="registro_password2" class="form-control" >
                    ...
                    <div>
                        ...
                        <div class="oh">
                            <div class="template_cont col-xs-6 col-md-4">
                                <div>
                                    <img src="application/views/reports/factura/modelo1/thumb.png" class="b b-a b-info wrapper-xs bg-white img-responsive">
                                </div>
                                <div class="radio">
                                    <label class="i-checks">
                                      <input type="radio" name="disenio_factura" value="modelo1" checked="">
                                      <i></i>Clasico
                                    </label>
                                </div>                                
                            </div>
                            <div class="template_cont col-xs-6 col-md-4">
                                <div>
                                    <img src="application/views/reports/factura/modelo1/thumb.png" class="b b-a wrapper-xs bg-white img-responsive">
                                </div>
                                <div class="radio">
                                    <label class="i-checks">
...
function subir_foto() {
    ...
    if (!isEmpty(path)) {
        ...
        formData.append("dir","uploads/imagenes"); // Directorio donde subir las imagenes
...
function guardar() {
    ...
    var password_1 = $("#registro_password").val();
    if (isEmpty(password_1)) {
        $("#tab1_link").trigger("click");
        alert("Ingrese una clave personal");
        $("#registro_password").select();
        return false;                    
    }
    var password_2 = $("#registro_password2").val();
    if (password_1 != password_2) {
        $("#tab1_link").trigger("click");
        alert("ERROR: Las claves no coinciden. Ingrese nuevamente.");
        $("#registro_password2").select();
        return false;
    }
    ...
    $("#registro_password").val(password_1);
