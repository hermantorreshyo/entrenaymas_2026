...
class Repartidores_Cajas_Movimientos extends REST_Controller {

  function __construct() {
    parent::__construct();
    $this->load->model('Repartidor_Caja_Movimiento_Model', 'modelo');
  }
  ...
  function listado() {
    ...
    $id_repartidor = $this->get_post("id_repartidor",0);
