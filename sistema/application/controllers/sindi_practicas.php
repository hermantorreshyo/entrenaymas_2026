...
class Sindi_Practicas extends REST_Controller {

  function __construct() {
    parent::__construct();
    $this->load->model('Sindi_Practica_Model', 'modelo');
  }
  ...
  function imprimir($id) {
    ...
    $this->db->query("UPDATE sindi_practicas SET impresa = 1 WHERE id = $id AND id_empresa = $id_empresa ");

    $this->load->view("reports/sindi/bonopractica", array(
      "practica"=>$datos,
      "titular"=>$titular,
    ));
    ...
    $this->Sindi_Historial_Model->registrar(array(
      ...
      "evento"=>"Bono Practica",
      "motivo"=>"Impresion Bono Practica Nro $datos->numero",
    ));
  }
