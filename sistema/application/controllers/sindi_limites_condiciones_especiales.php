...
class Sindi_Limites_Condiciones_Especiales extends REST_Controller {

  function __construct() {
    parent::__construct();
    $this->load->model('Sindi_Limite_Condicion_Especial_Model', 'modelo');
  }
  ...
  function delete($id = null) {
    ...
    $this->Sindi_Historial_Model->registrar(array(
      ...
      "motivo"=>"Condicion Especial: ".$condicion->nombre." Practica: ".$practica->nombre." Cantidad: ".$elemento->cantidad." Meses: ".$elemento->meses,
    ));
  ...
  function insert() {
    ...
    $sql = "SELECT * FROM sindi_limites_condiciones_especiales WHERE id_tipo_practica = $array->id_tipo_practica ";
    $sql.= "AND id_condicion_especial = $array->id_condicion_especial AND meses = $array->meses AND cantidad = $array->cantidad";
    ...
    $this->load->model("Sindi_Condicion_Especial_Model");    
    $condicion = $this->Sindi_Condicion_Especial_Model->get("$array->id_condicion_especial");    
    ...
    if ($quest->num_rows()>0) {
      parent::send_error("Ya existe el limite de ".$practica->nombre." para la condicion especial de ".$condicion->nombre." con ".$array->cantidad. " practica cada ".$array->meses. " ".$mes);
    }
