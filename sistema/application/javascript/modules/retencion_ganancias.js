...
(function ( app ) {
    ...
    app.views.RetencionGananciasParametros = Backbone.View.extend({

	template: _.template($("#retencion_ganancias_parametros_template").html()),
	...
	events: {
		...
		mostrar_mes: "MES_ANTERIOR",
            ...
            $(this.el).find("#retencion_ganancias_fechas_container").append(e.el);
	    ...
	    var empresa = $(this.el).find("#retencion_ganancias_empresa").val();
