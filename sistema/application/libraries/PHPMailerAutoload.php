...
//SPL autoloading was introduced in PHP 5.1.2; __autoload() fallback removed
//because declaring a function named __autoload() is a fatal compile error on PHP 8+.
